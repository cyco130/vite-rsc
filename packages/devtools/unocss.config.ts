...
// @unocss-include
export const devtoolsUIKitUnoPreset = (): Preset => ({
	...
	shortcuts: {
		...
		// radio
		"n-radio-box":
			"border n-border-base w-1.2em h-1.2em mr-1 text-white flex flex-none rounded-full overflow-visible",
...
export function extendUnocssOptions(user = {}) {
	return {
		...user,
		preflight: true,
		presets: [
	...
	shortcuts: [
		{
			...
			"glass-effect": "backdrop-blur-[3.5px] bg-white/80 dark:bg-slate-800/90",
